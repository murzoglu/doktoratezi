...
| **Plan belgesi** | `docs/analiz_planlari/04-sap-faz2-posthoc.md` v1.0 |
| **Sapma kaydı** | `docs/analiz_planlari/02-sapma-tablosu.md` satır #1 (Tip 3, post-hoc bütünleşik amendment) |
...
| **Amendment commit anchor** | `3f712c8` (origin/main, 2026-05-02) |
| **Yürütme statüsü** | Tüm 41 analitik hedef tamamlanmış ve doğrulanmıştır (2026-05-02) |

---

## 1. Amendment Niçin Açılıyor?

İki katmanlı OSF ön-kayıt stratejisi (Layer 1 ve Layer 2), psikometrik validasyon ve birincil hipotezler (H1–H5) için doğrulayıcı bir çerçeve sundu. Bu çerçeve içinde tüm birincil bulgular `03-sap-ana-plan.md` v3.0'a sadık kalınarak yürütüldü ve `docs/CLINICAL-STUDY-REPORT-FINAL.md` içinde konsolide edildi.
...
`04-sap-faz2-posthoc.md` v1.0 (2026-05-02 kapsam revizyonuyla), **17 KISIM (XIX–XXXV)** ve **41 aktif post-hoc analiz hedefi** içerir (yeni veri gerektiren 4 hedef — F2-19, F2-35, F2-38, F2-42 — kapsam dışına çıkarılmıştır). Bu amendment'in kapsamı söz konusu plan belgesindeki tüm KISIM'leri kucaklar:
...
Tetikleyici tarih: **2026-05-01**. Planlı bitiş: **2026-07-24**. **Gerçekleşen bitiş: 2026-05-02** — tüm sprint'ler hızlandırılmış olarak iki günde tamamlandı; kanonik kilit bütünlüğü ve test/audit zinciri korundu.
...
3. 02-sapma-tablosu.md → Tip 3 satırı eklendi (#1)
4. OSF Layer 3 amendment formu hazırlandı (bu doküman)
5. OSF Open-Ended Registration olarak submit edilecek
6. OSF GUID alındığında bu dokümanın metadata tablosuna yansıtılacak
7. OSF GUID alındığında 04-sap-faz2-posthoc.md başlığında referanslanacak
