...
| **Bağlanılan ana plan** | `03-sap-ana-plan.md` v3.0 (2026-04-27) — KISIM I-XVIII |
...
| **Tetikleyici/entegrasyon belgesi** | `docs/CLINICAL-STUDY-REPORT-FINAL.md` — önceki CSR v1.1/V2 boşlukları final rapora konsolide edildi |
| **OSF ek kayıt önerisi** | Layer 3: Post-hoc exploratory amendment — yerel amendment dokümanı hazır; OSF GUID yerel belgelerde henüz yok |
...
2. **Sapma tipi:** Pre-registration sapma sınıflandırmasında (`02-sapma-tablosu.md`) **Tip 3** sapmadır; OSF Layer 1 (`d524q`) veya Layer 2 (`pytfe`) kapsamında kabul edilmez.
...
|---|---|---|---|---|---|
| F2-01 | XIX | OSF Layer 3 amendment submit | `prepared` | — | `docs/analiz_planlari/05-osf-layer3-faz2-amendment.md`; OSF GUID yerel belgede yok |
| F2-02 | XX/50 | Trifactor T-CFA | `done` | `R/32_trifactor_model.R` | `outputs/tables/phase2_trifactor_fit_indices.csv`, `docs/assets/figures/carbon/phase2/phase2_f01_trifactor.svg` |
| F2-03 | XX/51 | Latent informant discrepancy SEM | `done` | `R/33_informant_discrepancy.R` | `outputs/tables/phase2_disc_latent_correlation.csv`, `phase2_disc_fit_indices.csv` |
| F2-04 | XX/52 | Latent Difference Score | `done` | `R/33_informant_discrepancy.R` | `outputs/tables/phase2_disc_variance.csv`, `phase2_disc_predictor_paths.csv` |
| F2-05 | XX/53 | Cross-informant GGM network | `done` | `R/34_cross_informant_network.R`, `R/48_phase2_apa_outputs.R` | `docs/assets/figures/carbon/phase2/phase2_f02_xinfo.svg`, `docs/assets/figures/carbon/phase2/phase2_f07_xinfo_network.svg` |
| F2-06 | XXI/54 | Floor-aware Tobit IRT | `done` | `R/35_floor_aware_irt.R` | `outputs/tables/phase2_floor_irt_group_delta.csv`, `docs/assets/figures/carbon/phase2/phase2_f03_floor_irt.svg` |
| F2-07 | XXI/55 | Reliability generalization (ω_h, ECV) | `done` | `R/36_reliability_generalization.R` | `outputs/tables/phase2_omegah_metrics_summary.csv` |
| F2-08 | XXI/56 | Beck cognitive vs somatic bifactor | `done` | `R/36_reliability_generalization.R` | `outputs/tables/phase2_omegah_metrics_summary.csv` içinde `domain = Beck` |
| F2-09 | XXI/57 | ESEM EMBU-P/C cross-loading | `done` | `R/37_esem_embu.R` | `outputs/tables/phase2_esem_loadings.csv`, `phase2_esem_target_summary.csv` |
| F2-10 | XXII/58 | Anne AD aracı (mediator) modeli | `done` | `R/38_antidepressant_pathway.R` | `outputs/tables/phase2_ad_mediator_estimates.csv`, `phase2_ad_mediator_sensitivity.csv` |
| F2-11 | XXII/59 | AD × Grup moderasyon (H1/H4/H5) | `done` | `R/38_antidepressant_pathway.R` | `outputs/tables/phase2_ad_moderation_h1_fixed_effects.csv`, `phase2_ad_moderation_h4_fixed_effects.csv`, `phase2_ad_moderation_h5_stratified_correlations.csv` |
| F2-12 | XXII/60 | Beck × AD latent etkileşim | `done` | `R/38_antidepressant_pathway.R` | `outputs/tables/phase2_ad_beck_interaction_fixed_effects.csv`, `phase2_ad_beck_interaction_status.csv` |
| F2-13 | XXIII/61 | MTMM diadik tutarlılık | `done` | `R/39_h5_extensions.R` | `outputs/tables/phase2_h5ext_mtmm_variance.csv`, `phase2_h5ext_mtmm_fit_indices.csv` |
...
| F2-24 | XXV/72 | 3-level varyans yapısı negctrl | `done` | `R/42_dag_pc_fci.R` | `outputs/tables/phase2_dag_three_level.csv`, `docs/assets/figures/carbon/phase2/phase2_f10_dag_validation.svg` |
| F2-25 | XXVI/73 | Quantile regression (üst kuyruk) | `done` | `R/43_distributional.R` | `outputs/tables/phase2_dist_quantile.csv` |
| F2-26 | XXVI/74 | Distributional regression | `done` | `R/43_distributional.R` | `outputs/tables/phase2_dist_distributional_posterior.csv` |
| F2-27 | XXVI/75 | Beta regression (bounded EMBU) | `done` | `R/43_distributional.R` | `outputs/tables/phase2_dist_beta.csv` |
| F2-28 | XXVII/76 | H1 multiverse (240 spec) | `done` | `R/44_multiverse_extension.R` | `outputs/tables/phase2_multi_h1_spec_results.csv`, `docs/assets/figures/carbon/phase2/phase2_f05_h1_spec_curve.svg` |
| F2-29 | XXVII/77 | H4 SEM multiverse | `done` | `R/44_multiverse_extension.R` | `outputs/tables/phase2_multi_h4_spec_results.csv`, `phase2_multi_h4_summary.csv` |
| F2-30 | XXVII/78 | BMA across multiverse | `done` | `R/44_multiverse_extension.R` | `outputs/tables/phase2_multi_bma.csv` |
| F2-31 | XXVII/79 | SCA inferential test (n_perm=5000) | `done` | `R/44_multiverse_extension.R` | `outputs/tables/phase2_multi_sca_inferential.csv` |
| F2-32 | XXVIII/80 | Bayesian meta-analytic pooling | `done` | `R/45_bayesian_meta.R` | `outputs/tables/phase2_meta_pooling_summary.csv`, `docs/assets/figures/carbon/phase2/phase2_f06_meta_forest.svg` |
| F2-33 | XXVIII/81 | Posterior predictive replication | `done` | `R/45_bayesian_meta.R`, `R/48_phase2_apa_outputs.R` | `docs/assets/figures/carbon/phase2/phase2_f11_ppc_replication.svg` |
| F2-34 | XXVIII/82 | Empirical Bayes shrinkage | `done` | `R/45_bayesian_meta.R` | `outputs/tables/phase2_meta_eb_shrunk.csv`, `phase2_meta_eb_outlier_summary.csv` |
| ~~F2-35~~ | ~~XXIX/83~~ | ~~TRIPOD-Cluster hazırlık çerçevesi~~ | **`removed`** | — | **Yeni (dış-validasyon) veri gerektirdiği için çıkarıldı** |
| F2-36 | XXIX/84 | sNB genişletmesi | `done` | `R/46_clinical_dx_extension.R` | `outputs/tables/phase2_clinical_snb.csv`, `phase2_clinical_fit_summary.csv` |
| F2-37 | XXIX/85 | DCA threshold heatmap | `done` | `R/46_clinical_dx_extension.R`, `R/48_phase2_apa_outputs.R` | `docs/assets/figures/carbon/phase2/phase2_f12_dca_heatmap.svg` |
| ~~F2-38~~ | ~~XXIX/86~~ | ~~Risk skor recalibration~~ | **`removed`** | — | **Dış validasyon verisi gerektirdiği için çıkarıldı** |
| F2-39 | XXX/87 | simr multilevel power | `done` | `R/47_power_replication.R` | `outputs/tables/phase2_power_multilevel.csv` |
| F2-40 | XXX/88 | APIM sample size (Ackerman 2016) | `done` | `R/47_power_replication.R` | `outputs/tables/phase2_power_apim.csv` |
...
`02-sapma-tablosu.md` mevcut sürümünde Tip 3 (major) sapma sayısı **0**'dır. Faz II analizleri **tek bir blokta 45 yeni Tip 3 sapma** olarak işlenir. Bu blok sayesinde her bireysel analiz için ayrı Tip 3 satırı yerine **tek bir "Faz II Bütünleşik Amendment" satırı** açılır; her alt-analiz amendment'a referans verir.

### 47.2 Yeni Sapma Satırı Şablonu

Aşağıdaki satır `02-sapma-tablosu.md` dosyasına eklenir:

```markdown
| 1 | 2026-05-01 | Layer 1 + Layer 2 | Sadece KISIM I-XVIII | Faz II SAP (KISIM XIX-XXXV) eklendi: 45 post-hoc analiz tetiklendi (CSR v1.1 ve CSR-V2 sonrası) | Tip 3 | Çalışma sonu verileri ışığında ortaya çıkan psikometrik sınırlamalar (EMBU reddetme α/ω düşüklüğü, H4 SEM CFI sınır altı), klinik moderator boşlukları (anne antidepresan SMD=0.53), strateji-düzeyi diadik tutarlılık çelişkisi (H5) ve dış validasyon hazırlığı için ek analiz hattı | docs/analiz_planlari/04-sap-faz2-posthoc.md |
```
...
| **Layer 3 (yeni)** | **Faz II post-hoc exploratory amendment** | **GUID bekleniyor** | `prepared` |
...
- **Files attached:**
  1. `04-sap-faz2-posthoc.md` (bu dosya)
  2. CSR v1.1 ve CSR-V2 (tetikleyici belgeler)
  3. Updated `02-sapma-tablosu.md`
...
3. 02-sapma-tablosu.md → Tip 3 satırı ekle
...
### 93.2 Gerçekleşen Carbon Şekil Listesi (12 APA figürü)

| Carbon ID | SAP/Tracker karşılığı | Şekil | Çıktı |
|---|---|---|---|
| F2-F01 | F2-02 / XX/50 | Trifactor loading panel | `docs/assets/figures/carbon/phase2/phase2_f01_trifactor.svg` |
| F2-F02 | F2-05 / XX/53 | Cross-informant edge dağılımı | `docs/assets/figures/carbon/phase2/phase2_f02_xinfo.svg` |
| F2-F03 | F2-06 / XXI/54 | Floor-aware IRT latent theta farkı | `docs/assets/figures/carbon/phase2/phase2_f03_floor_irt.svg` |
| F2-F04 | F2-14 / XXIII/62 | H5 stratified diadic correlation | `docs/assets/figures/carbon/phase2/phase2_f04_h5_strat.svg` |
...
| F2-F12 | F2-37 / XXIX/85 | DCA threshold-sensitivity heatmap | `docs/assets/figures/carbon/phase2/phase2_f12_dca_heatmap.svg` |
...
- [ ] 02-sapma-tablosu.md güncelleme satırı hazır
