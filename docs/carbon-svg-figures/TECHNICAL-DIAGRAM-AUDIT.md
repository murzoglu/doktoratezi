...
|---|---|---|---|---|---|
| strobe_flow | [fig-01-strobe-flow.svg](fig-01-strobe-flow.svg) | Flow shape + Flow number + Connector + Label pill | PASS: custom Technical Diagram SVG; no chart grid/axis/raster layer | PASS: full Figma Technical Diagram Library SVG | PASS: Carbon Charts |
| causal_dag | [fig-02-causal-dag.svg](fig-02-causal-dag.svg) | Large node + Connector + Legend | PASS: custom Technical Diagram SVG; no chart grid/axis/raster layer | PASS: full Figma Technical Diagram Library SVG | PASS: Carbon Charts |
| h2_apim_path | [fig-09-h2-apim-path.svg](fig-09-h2-apim-path.svg) | Large node + Connector line ending + Label text | PASS: custom Technical Diagram SVG; no chart grid/axis/raster layer | PASS: full Figma Technical Diagram Library SVG | PASS: Carbon Charts |
| h4_sem_path | [fig-11-h4-sem-path.svg](fig-11-h4-sem-path.svg) | Large node + Connector line ending + Label text | PASS: custom Technical Diagram SVG; no chart grid/axis/raster layer | PASS: full Figma Technical Diagram Library SVG | PASS: Carbon Charts |
| network_graph | [fig-16-network-graph.svg](fig-16-network-graph.svg) | Small node + Connector + Legend | PASS: custom Technical Diagram SVG; no chart grid/axis/raster layer | PASS: full Figma Technical Diagram Library SVG | PASS: Carbon Charts |
