...
Bulgular, Türk pediatrik T1DM ailelerinde anne öz-bildirimi düzleminde sistematik bir grup farkının olmadığını; çocuk perspektifi düzleminde ise reddetme algısında DM lehine küçük-tutarlı bir yükselme bulunduğunu göstermektedir. Bu desen, ISPAD 2024 ve ADA 2025/2026 kılavuzlarının çift-perspektifli aile değerlendirmesi önerisini deneysel olarak desteklemekte; aynı zamanda anne depresyonunun ebeveynlik tutumları üzerindeki orta-büyük yapısal etkisinin grup üyeliğinden bağımsız evrensel bir mekanizma olarak işlediğini ortaya koymaktadır. Etki büyüklükleri Cohen küçük etki kategorisindedir; randomize müdahale tasarımları için orta-hassasiyetli pilot kanıt niteliği taşımaktadır.
...
International Society for Pediatric and Adolescent Diabetes (ISPAD) 2024 Klinik Pratik Konsensüs Kılavuzları'nın psikososyal bakım bölümü ve American Diabetes Association Standards of Care 2025/2026 önerileri (Madde 14.9–14.11), T1DM tanılı çocukların **tanı anında ve rutin takipte** çoklu informant tabanlı, geçerlik kanıtı taşıyan araçlarla psikososyal taramaya tabi tutulmasını şart koşmaktadır. NICE Guideline NG18 (2023 güncelleme) aynı doğrultuda aile-merkezli bakımı, ergen-bağımsızlık geçişini ve davranış sağlığı uzmanlarının pediatrik takıma entegrasyonunu vurgulamaktadır. Mevcut çalışma, söz konusu klinik kılavuzların *çift-perspektifli aile değerlendirmesi* önerilerini Türk popülasyonunda operasyonelleştiren ampirik bir prototip olarak konumlanmaktadır.
...
Çoklu-informant çerçeve, uyumsuzluğun *ölçüm hatası* değil **alana ilişkin ek bilgi** olarak okunmasını öngörmekte; bu yaklaşım, klinik müdahale planlamasında *kim, ne, nerede* sorularına farklılaşmış yanıtlar üretebilmek için bir epistemik temel sunmaktadır.

## 6.4 Anne Depresyonu, Ebeveynlik ve Çocuk Algısı Zinciri

Goodman ve Gotlib'in (1999) entegratif modeli, anne depresyonunun çocuk gelişim çıktılarına dört aracı (genetik, prenatal, ebeveynlik davranışları ve stres) üzerinden iletildiğini öne sürmektedir. Lovejoy ve diğerlerinin (2000) 46 gözlemsel araştırmayı havuzlayan meta-analizi, anne depresyonu ile olumsuz ebeveynlik arasında d = 0,40, geri çekilme arasında d = 0,29 ve azalan olumlu davranış arasında d = 0,16 etki büyüklükleri raporlamıştır. Mevcut çalışma, bu zincirin anne öz-bildirimi düzeyindeki yapısal yansımasını (anne depresyonu → ebeveynlik tutumları) latent yapısal eşitlik modeliyle değerlendirmiş; aynı zamanda zincirin çocuk algı düzeyine iletim kapasitesini aracılık analizleri ile sınamıştır.

## 6.5 Çalışmanın Doldurduğu Boşluk

Mevcut Türk literatüründe, T1DM ailelerinde (i) anne öz-bildirimi ile çocuk algısının paralel ölçüldüğü, (ii) sağlıklı kardeşin de aynı ölçek setiyle değerlendirildiği, (iii) propensity score yöntemleriyle gözlenebilir karıştırıcıların kontrol edildiği, (iv) Bayesçi paralel raporlamayla negatif bulguların yorumlandığı ve (v) çoklu sensitivite katmanıyla araştırmacı serbestliğinin denetlendiği kapsamlı bir vaka-kontrol çalışması bulunmamaktadır. Bu çalışma, beş eksiği eşzamanlı kapatma iddiasıyla yürütülmüştür.
...
Furman ve Buhrmester'in (1985) Sibling Relationship Questionnaire'ının 48 maddelik beşli Likert formu, Türkçeye Apalaçi (1996) tarafından uyarlanmıştır. Dört yüksek-düzey alt ölçek değerlendirilmiştir: sıcaklık/yakınlık, statü/güç, çatışma ve rekabet (anne ve baba kayırması maddelerinin ortalaması). Anket hem indeks hem sağlıklı kardeş tarafından doldurulmuştur. Aynı düad içindeki iki rapor bağımsız olmadığı için aktör-partner karşılıklı bağımlılık modelinin kullanılması metodolojik olarak zorunludur.
...
> **Yöntem kutusu — DAG.** Nedensellik haritası, hangi değişkenlerin hangilerini etkilediğine ilişkin teorik varsayımları görselleştiren bir grafik araçtır. Bu harita, hangi karıştırıcının kontrol edilmesi, hangisinin kontrol edilmemesi gerektiğini matematiksel olarak belirler — yani "hangi değişkeni modele eklemeliyim?" sorusu sezgisel değil, kuramsal bir kararla yanıtlanır.

Aile yapısı, anne özellikleri ve ebeveynlik tutumları arasındaki nedensel akış yönlü bir grafik çerçevesi ile haritalanmıştır. Birincil etki modellerinde (H1–H3) ayarlanan kovaryat seti **{kardeş yaş farkı; aile büyüklüğü; latent SES}** olarak sabitlenmiştir. Anne antidepresan kullanımı, anne Beck depresyon skoru ve ebeveynlik tutumu birincil modellerde ayarlanmamış; bunun yerine bu değişkenler aracılık ya da duyarlılık analizlerinde değerlendirilmiştir. Bu karar, yaygın bir epistemik tuzaktan (aracı değişkeni ana etki modelinde kovaryat olarak ekleme yoluyla anlamı silme — "over-adjustment bias") kaçınmak için alınmıştır.
...
> **Yöntem kutusu — Propensity score (eğilim skoru).** Vaka-kontrol gibi gözlemsel çalışmalarda DM ile Kontrol gruplarının başlangıç özellikleri her zaman tam dengeli olmayabilir. Eğilim skoru, bir kişinin gözlenen özellikleri verildiğinde DM grubuna ait olma "şansını" hesaplar; bu şansın tersi kullanılarak (ters-olasılık ağırlıklandırması, IPTW) gruplar yapay olarak dengelenir. Sonuç, randomize bir çalışmaya yaklaşan bir karşılaştırma zemini oluşturur. Doubly-robust yaklaşım, hem ağırlıklandırma hem de kovaryat ayarlamasını birlikte yapar; ikisinden biri doğru olduğu sürece tahmin tutarlıdır.

Birincil eğilim skoru modeli, DAG kararına bağlı olarak `DM grubu ~ latent SES + kardeş yaş farkı + aile büyüklüğü` formülasyonuyla lojistik regresyon kullanılarak tahmin edilmiştir. Stabilize ağırlıklar 99'uncu yüzdelikte budanmış (trim) ve dengeleme uygulanmıştır. Eğilim skoru ortalaması 0,498 ve standart sapması 0,055; ortak destek bandı 0,39–0,67 olup yalnız 4 aile band dışında kalmıştır. Ham gözlemde maksimum standardize ortalama farkı 0,220 iken ağırlıklandırma sonrası 0,004'e düşmüştür; bu, ayarlama setinin başarılı dengeleme sağladığını göstermektedir. 1:1 en yakın komşu eşleme (caliper 0,20 SD logit ölçüsünde) yardımcı duyarlılık analizi olarak yürütülmüştür.

## 8.9 Birincil Hipotez Test Yöntemleri

### 8.9.1 H1 — Çocuk algısı için çok-düzeyli kovaryans analizi

> **Yöntem kutusu — Çok-düzeyli model (multilevel).** Bir aileden iki çocuk veri girdiği için bu iki çocuğun puanları birbirinden bağımsız değildir; aile içi etkenler her iki çocuğu da etkiler. Çok-düzeyli model, "her aile için ortak bir kayma" parametresi (rastgele kesişim) ekleyerek bu bağımlılığı hesaba katar. Eğer böyle bir bağımlılık görmezden gelinirse, sıradan modeller aile-içi etkileri sahte biçimde abartır ve standart hatalar gerçekten daha küçük görünür.

Dört EMBU-C alt ölçeği için (sıcaklık, aşırı koruma, reddetme, karşılaştırma) çocuk düzeyi (n = 482) bir kovaryans analizi modeli kurulmuştur. Sabit etkiler arasında dört düzeyli rol değişkeni (Kontrol indeks, Kontrol kardeş, DM indeks, DM kardeş), çocuk yaşı, çocuk cinsiyeti, latent SES, kardeş yaş farkı ve aile çocuk sayısı yer almıştır. Aile düzeyi rastgele kesişim, aynı aileden iki çocuk arasındaki korelasyonu modelin yapısına dahil etmiştir. Aile içi sınıf-içi korelasyon yaklaşık 0,14 olup çok-düzeyli modelin metodolojik zorunluluğunu doğrulamaktadır (Hox, 2018 eşiği 0,05). Çok yönlü etkileşim olarak rol × yaş × cinsiyet üçlüsü ayrı bir genişletme modelinde değerlendirilmiştir.
...
> **Yöntem kutusu — APIM (aktör-partner karşılıklı bağımlılık modeli).** Aynı düad içinde iki kişinin (kardeş 1, kardeş 2) puanları birbirini etkiler. Aktör etkisi: kişinin kendi yanıtının kendi puanına etkisi. Partner etkisi: kardeşin yanıtının kişinin puanına etkisi. APIM, bu iki etkiyi aynı modelde aynı anda tahmin ederek düad bağımlılığını doğru biçimde yansıtır.

Kardeş ilişkisi mimarisinin grup farkı için üç paralel strateji uygulanmıştır:
...
3. **Olsen-Kenny ayırt edilebilir düad doğrulayıcı faktör analizi:** SRQ kavga-temelli (quarreling) madde seti üzerinden indeks-kardeş latent korelasyonu, ölçüm hatasından arındırılmış biçimde tahmin edilmiştir.
...
Anne Beck depresyon latent faktörünün dört EMBU-P latent faktörünü (sıcaklık, aşırı koruma, reddetme, karşılaştırma) yordadığı bir yapısal eşitlik modeli, ordinal verinin tüm madde havuzu üzerinden WLSMV kestirimcisiyle tahmin edilmiştir. Yapısal kovaryatlar olarak latent SES ve anne yaşı ayarlanmıştır. DM × Kontrol multi-grup invaryans taraması, bir alt-ölçekte yapısal yolun grup üyeliğinden bağımsız işlerliğini doğrulamak için planlanmıştır. Bayesçi varyant `blavaan` ile preflight (model + prior + sampler) düzeyinde belgelenmiş; default analiz hattında posterior örneklemesi yapılmamıştır.
...
Hipotez ailesi içinde yanlış pozitif kontrolü için Benjamini-Hochberg yanlış keşif oranı (FDR) kullanılmıştır (q = .05). Beş aile bağımsız olarak düzeltilmiştir: H1 ailesi (4 EMBU-C alt ölçeği), H2 ailesi (4 SRQ alt ölçeği), H3 ailesi (4 EMBU-P alt ölçeği), H4 ailesi (Beck'ten 4 EMBU-P latent boyutuna giden yapısal yollar) ve H5 ailesi (3 düad tipi × 4 alt ölçek için ICC ve RSA testleri). Aileler arası FDR uygulanmamış; her aile bağımsız değerlendirilmiştir.
...
1. **Anne antidepresan kullanımı** çalışmadaki en güçlü dengesizliktir: DM grubunda %29, Kontrol grubunda %9 düzeyindedir; SMD = 0,53 ciddi dengesizlik eşiğinin üzerindedir. Bu değer, DM grubunda anne antidepresan kullanım oranının kontrol grubuna kıyasla yaklaşık 3,2 kat daha yüksek olduğunu göstermektedir. Bu bulgu, kronik hastalık çocuklu annelerin yüksek psikiyatrik bakım yüküne ilişkin uluslararası literatür ile (Cousino ve Hazen, 2013; Bassi ve diğerleri, 2020) tutarlıdır ve klinik perinatal psikiyatri tarama programlarının T1DM bakım hizmetine entegre edilmesi gerekliliğini ampirik olarak desteklemektedir.
...
Eğilim skoru hattı, ham gözlemde maksimum |SMD| = 0,220 olan ayarlama seti dengesizliğini, ters-olasılık ağırlıklandırması sonrası 0,004 düzeyine indirmiştir. Bu, randomize bir karşılaştırma zeminine yaklaşan bir denge profili sağlamış olmaktadır.
...
Çalışmanın ölçek geçerlik ve güvenirlik analizleri, COSMIN ve ITC Test Adaptation Guidelines uyumlu bir çerçevede ayrı bir bütünleşik raporda sunulmuştur. Bu bölüm, klinik çalışma raporu açısından gerekli kararsal özetleri vermektedir.
...
Hu ve Bentler'in (1999) birleşik kriteri (CFI ≥ 0,95 + SRMR ≤ 0,08) bu örneklemde her iki form için karşılanmamıştır; ancak Marsh, Hau ve Wen'in (2004) küçük örneklemlerde uyum eşiklerinin uyarlanması gerektiğine dair önerisi çerçevesinde dört-faktör çözümü "kabul edilebilir ancak sınırlı" yapısal kanıt olarak değerlendirilmiştir. Aile-kümelenmesine duyarlı sürekli-MLR cluster CFA, ordinal CFA'nın yerini almak yerine aile içi bağımlılığın model uyumuna etkisinin tamamlayıcı bir kontrolü olarak raporlanmıştır.

## 10.3 Madde Düzeyi Taban Etkisi

EMBU-P reddetme alt ölçeğinin **8 maddesinden 7'sinde % 80'in üzerinde taban etkisi** gözlenmiştir; madde düzeyi taban aralığı %62,2–%95,9 düzeyindedir. EMBU-C reddetme alt ölçeğinde **8 maddenin 3'ünde % 80'in üzerinde taban etkisi** bulunmuş; madde düzeyi taban aralığı %39,8–%84,4 düzeyindedir. Bu dağılım kısıtı, korelasyon, CFA yükü ve grup farkı tahminlerini sistematik olarak aşağı çekme eğilimindedir; bu nedenle reddetme alt ölçeğine ilişkin bulgular yalnız toplam puan düzeyinde değil madde dağılımı düzeyinde de temkinli okunmuştur.

## 10.4 Ölçüm Değişmezliği (Multi-Group Invariance)

DM × Kontrol, yaş ve cinsiyet kategorileri için configural, metric ve scalar düzeylerde sırayla ölçüm değişmezliği test edilmiştir. Cheung ve Rensvold (2002) standardına göre ΔCFI < 0,010 ve ΔRMSEA < 0,015 kriterleri uygulanmıştır. Configural ve metric değişmezlik büyük ölçüde sağlanmış; scalar değişmezlik sınır düzeyde kabul edilmiştir. Bu bulgu, gruplar arası ortalama karşılaştırmalarının tam scalar değişmezlik koşulunu marjinal düzeyde karşıladığını; bu nedenle birincil etki büyüklüklerinin metrik düzeyde yorumlanmasının daha güvenli olduğunu işaret etmektedir.

## 10.5 Kriter ve Eşzamanlı Geçerlik

EMBU-P/C alt ölçekleri, Beck total ve SRQ alt ölçekleri arasında 14 paralel korelasyon testi uygulanmış; tüm korelasyon p-değerleri Benjamini-Hochberg FDR ailesi içinde düzeltilmiştir. Kriter geçerliği açısından beklenen örüntülerin belirgin bir kısmı doğrulanmıştır: anne reddetmesi ile anne depresif belirtileri arasında orta-büyük pozitif ilişki, çocuk algısında karşılaştırma alt ölçeği ile SRQ çatışma alt ölçeği arasında güçlü pozitif ilişki, anne sıcaklığı ile çocuk sıcaklığı arasında orta düzey pozitif ilişki gözlenmiştir.
...
H1 reddetme alt ölçeği için klasik test (FDR p < .01), Bayes faktörü (BF₁₀ = 8,12; orta düzey H1 lehine), madde-yanıt teorisi latent doğrulaması (β = 0,14 SD) ve aile-içi sınıf-içi korelasyon (yaklaşık 0,14) birlikte değerlendirildiğinde, **DM çocuklarının kontrol çocuklarına kıyasla küçük-tutarlı düzeyde yüksek reddetme algısı sergiledikleri yönünde orta-güçlü kanıt birikimi** elde edilmiştir. Etki büyüklüğü Funder ve Ozer (2019) sınıflandırmasında "küçük fakat birikimsel olarak önemli" alana denk düşmektedir.
...
H2 birincil hipotezi olan "T1DM kardeş çiftlerinde çatışma alt ölçeği yüksektir" iddiası **veri tarafından desteklenmemiştir**; ancak negatif sonuç "indeterminate" konumunda raporlanmıştır. Bulgu, T1DM ailelerinde kardeş ilişkisi mimarisinin temel boyutlarının (sıcaklık, statü, çatışma, rekabet) hastalık varlığından bağımsız olarak korunduğunu düşündürmekte ve Stuart ve Hodges'ın (2003) kardeş kronik hastalık literatüründeki karma sonuçlarıyla tutarlıdır. Daha küçük düzeydeki olası farkları tespit etmek için APIM tipi modellerin gerçekleştirilmiş güç değerlendirmesi gelecek faz için planlanmıştır.
...
Dört EMBU-P alt ölçeği için **üç-katmanlı negatif kanıt zinciri** hizalı şekilde anne öz-bildirimi düzleminde DM × Kontrol farkı yokluğunu desteklemektedir: (i) klasik test FDR p > .50; (ii) Cohen d standardize etkileri |d| < 0,17; (iii) Bayes faktörü 0,17–0,25 aralığında ("orta düzey H0"). Aşırı koruma ve karşılaştırma alt ölçekleri ek olarak TOST ile **kesin eşdeğer** olarak konumlandırılmıştır. Bu bulgu, T1DM annelerinin "sistematik olarak farklı ebeveynlik davranışları sergiledikleri" hipotezinin Türk klinik pratikte ampirik temelinin sınırlı olduğunu göstermektedir.
...
**Dört yapısal yoldan üçü** FDR-düzeltilmiş olarak istatistiksel anlamlıdır: Beck depresyon arttıkça sıcaklık latent faktörü azalmakta, reddetme ve karşılaştırma latent faktörleri artmaktadır. **Aşırı koruma yolu yön olarak pozitif (β = 0,08); ancak FDR p = .22 ile anlamlı değildir.** Bu desen, anne depresif belirti yükünün ebeveynlik tutumlarındaki etkisinin **alt-boyut-spesifik** olduğunu — özellikle olumlu (sıcaklık) ve olumsuz (reddetme, karşılaştırma) boyutlarda işlerken aşırı koruma kanalında bağımsız mekanizmalardan beslenebileceğini — düşündürmektedir.
...
H4 hipotezi ön-kayıtlı yönde **kısmen doğrulanmıştır**: Anne depresif belirti yükü, dört EMBU-P alt ölçeğinden üçünde (sıcaklık, reddetme, karşılaştırma) orta-büyük etki büyüklüğünde anlamlı yapısal yollar üretmiştir (anlamlı yollar için |std. β| = 0,28–0,33). Aşırı koruma yolu pozitif yöndedir ancak FDR-düzeltilmiş anlamlılığa ulaşmamıştır (β = 0,08, FDR p = .22). Etki büyüklükleri Lovejoy ve diğerlerinin (2000) negatif anne davranışı için raporladığı meta-analitik d = 0,40 değerinin alt sınırı olan **orta-büyük etki sınıfında** kümelenmektedir.
...
Bu düzey Cicchetti'nin (1994) eşiklerinde "fakir-zayıf" uyum bandına denk gelmektedir. Manifest düzeyde DM grubunun ICC değerleri Kontrol grubundan daha düşüktür.
...
Bu örüntü, Streisand ve Monaghan'ın (2014) kronik hastalık ailelerinde anne savunmacılığı hipoteziyle uyumlu yön sergilemektedir.
...
> **Yöntem kutusu — Aracılık (mediation).** "X değişkeni Y değişkenini etkiler mi?" sorusuna ek olarak "bu etki bir Z değişkeni üzerinden mi geçiyor?" sorusu sorulduğunda aracılık analizi devreye girer. Anne depresyonunun çocuk algısına etkisi anne ebeveynlik tutumu üzerinden mi iletilmektedir? Bu zincir üç farklı modelle test edilmiştir: tek-aracı modeli (klasik Hayes-Preacher), çok-düzeyli aracı modeli (aile yapısını hesaba katan) ve koşullu süreç modeli (zincirin grup üyeliği tarafından moderate edilip edilmediğini test eden).
...
Sonuç: **Beck → EMBU-P köprüsünün varlığına karşın EMBU-P → EMBU-C kopukluğu** açıkça raporlanmıştır. Bu, H4 yapısal modelinde Beck → EMBU-P yolunun anlamlı olmasıyla (β = 0,28–0,33), ancak anne ebeveynlik tutumunun çocuk algısını sistematik biçimde yordamaması ile uyumlu bir bulgudur. Klinik anlam: Anne depresyonu anne öz-bildirim ebeveynliği etkilemekte; ancak bu etki çocuk algı düzeyine sistematik olarak iletilmemektedir. Bu bulgu, De Los Reyes ve diğerlerinin (2015) Operations Triad Modeli'nde **Diverging Operations** deseninin tam ampirik karşılığını sunmaktadır.

## 12.2 Latent Profil Analizi (Anne Tipolojisi)

> **Yöntem kutusu — Latent profil analizi.** Sürekli ölçeklerden (Beck, EMBU-P, SES) yola çıkarak anneleri gizli alt-tiplere ayıran istatistiksel bir tekniktir. "Anneler kaç farklı 'tipte' kümeleniyor?" sorusuna yanıt arar. Profil sayısı için BIC (Bayes bilgi kriteri), entropy (sınıflandırma netliği) ve BLRT (olasılık oranı testi) birlikte kullanılır.

Beck total, dört EMBU-P alt ölçeği ve latent SES değişkenleri üzerinde tidyLPA `estimate_profiles` fonksiyonu ile 1–5 profil çözümü karşılaştırılmıştır. BIC en uygun model olarak **3-profil çözümünü** seçmiştir (BIC = 3951; 2 profile karşı 1 profile BLRT p = .01; 3 profile karşı 2 profile BLRT p = .01; entropy = 0,81). Üç profil ortalama özellikleri kabaca şu şekilde yorumlanabilir:
...
Bu etiketler betimseldir ve klinik tanı veya tedavi önerisi olarak kullanılmamaktadır.
...
> **Yöntem kutusu — Gauss grafik modeli (GGM).** Değişkenler arasındaki "kısmi korelasyon" yapısını ağ olarak görselleştirir; her bir bağlantı, diğer tüm değişkenlerin etkisi kontrol edildiğinde geriye kalan ilişkiyi gösterir. Merkezi düğüm, ağda en yoğun bağlanan ve "köprü işlevi" gören değişkendir. Ağ bulgular **koşullu bağımlılık** olarak yorumlanır; nedensel yön çıkarımı yapılmaz.
...
Ağ Karşılaştırma Testi (200 permütasyon) DM (n = 117) ve Kontrol (n = 121) ağları arasında global strength invaryans p = .86 ve maksimum kenar farkı p = .77 değerleriyle iki grup ağ yapısının önemli ölçüde değişmediğini göstermiştir.
...
- Temel modelde AUC = 0,58 (%95 GA [0,50; 0,67]), optimism-corrected AUC = 0,61 bulunmuştur.
...
- Karar eğrisi analizi 0,10–0,40 risk eşik aralığında "herkesi tara" ve "kimseyi tarama" stratejilerine göre genişletilmiş modelin net fayda sağladığını göstermiştir.
- Kalibrasyon eğrisi intercept ≈ 0 ve slope ≈ 1 düzeyine yakın kabul edilebilir kalibrasyon profili sergilemiştir.

Bu model, **dış-validasyon bekleyen** bir prototip olarak konumlandırılmıştır; bağımsız Türk merkezlerinde TRIPOD-Cluster çerçevesinde dış validasyon, gelecek araştırma gündeminin önceliklerinden biridir.

## 12.5 DM Klinik Alt-Analizler (KISIM X)
...
Bu örüntü, T1DM klinik göstergelerinin anne öz-bildirim ebeveynlik tutumlarıyla bu örneklemde non-linear bir bağlantı sergilemediğini düşündürmektedir. Ne var ki **n = 39 düzeyindeki HbA1c örneklemi, küçük-orta etki büyüklüklerini tespit etmek için açıkça yetersiz güçtedir** (Cohen, 1988 standardında power < 0,50). Bulgu güç sınırlamasıyla birlikte yorumlanmıştır.
...
İki alt ölçekte "Equivalent" konumlanması, çalışmanın *aktif sıfır kanıtı* sunduğu boyutları açıkça belgelemektedir.
...
Sekiz sahte yordayıcı-outcome eşlemesi uygulanmış; çoklu testler arasında 1 "şüpheli" sonuç tespit edilmiştir. Bu oran çoklu test rastgele yanlış pozitif beklentisi (1/20 ≈ %5) içinde kalmaktadır ve gerçek bir sapmanın işareti olarak değerlendirilmemiştir.
...
Bayesçi sonuçlar frequentist analizleri sıkı biçimde desteklemekte ve **yorum belirsizliklerini** netleştirmektedir:

- **H1 reddetme** için BF₁₀ = 8,12 ("orta düzey H1 lehine kanıt") frequentist sonucu (FDR p < .01) sağlamlaştırmaktadır.
- **H3 reddetme** için BF₁₀ = 0,17 ve ROPE içi pay %92, klasik testin "anlamsız" sonucunu **"sıfır lehine güçlü kanıt"** olarak yeniden yorumlamayı mümkün kılmaktadır. Bu, "kanıt yetersizliği" ile "aktif sıfır kanıtı" ayrımının bu boyutta açıkça kurulabildiğini göstermektedir.

\newpage

# 15. TARTIŞMA

## 15.1 Genel Yorum Çerçevesi: Üç Bilgi Kaynağı Asimetrisi

Bu çalışmanın en belirgin örüntüsü, ebeveynlik tutumlarının ölçüldüğü üç kaynak (anne öz-bildirimi, çocuk algısı ve düad-içi uyum) arasında sistematik bir asimetri sergilemesidir. Anne öz-bildirimi düzleminde DM × Kontrol farkı için kanıt belirgin biçimde yetersizdir (H3); çocuk algısı düzleminde DM çocuklar reddetme alt ölçeğinde Kontrol gruptan küçük-tutarlı bir asimetri göstermektedir (H1); anne–çocuk diadik uyum ise DM ve Kontrol gruplarında farklı manifest ve latent örüntüler sergilemektedir (H5). Bu üç bilgi kaynağı asimetrisi, De Los Reyes ve diğerlerinin (2015) Operations Triad Modeli çerçevesinde **Diverging Operations** deseninin tam ampirik karşılığını sunmaktadır: aynı yapıyı (örneğin "anne reddetmesi") farklı bilgi verenlerin farklı kanallarda işlemesi, ölçüm hatasından öte bir alana ilişkin bilgidir.

## 15.2 H1 Tartışması: Çocuk Algısında DM Lehine Reddetme Yükselmesi

H1 reddetme alt ölçeğinde elde edilen β = 0,16 SD (%95 GA [0,05; 0,26]) etki büyüklüğü, Funder ve Ozer'in (2019) etki büyüklüğü kademesinde "küçük fakat birikimsel olarak önemli" alana denk düşmektedir. Schäfer ve Schwarz'ın (2019) ön-kayıtlı psikolojik araştırmalardaki r = 0,16 medyan etki büyüklüğü referansı ile karşılaştırıldığında, bulgu *yayın yanlılığından arındırılmış gerçek etki büyüklüğü dağılımının* tipik aralığında konumlanmaktadır. Pinquart'ın (2013) çocuk-değerlendirici alt grubunda raporladığı hastalığa-özgü olumsuz algı yön ve büyüklüğüyle uyumludur; ancak Pinquart'ın havuzlanmış aşırı koruma g = 0,39 değerinden çok daha küçüktür.

H1 ile H3'ün asimetrisi — çocuk algısında reddetme yükselmesi (BF₁₀ = 8,12) varken, anne öz-bildirimi düzeyinde aynı boyutta fark yokluğu (BF₁₀ = 0,17, ROPE içi pay %92) — Diverging Operations deseninin somut bir örneği olarak okunmaktadır. Bu desen, T1DM çocuklarının annelerinin ebeveynlik davranışlarını anneleriyle aynı şekilde algılamadıklarını; hastalık deneyiminin algısal bir yansıması olarak reddetme boyutunda farklı bir alımlama geliştirdiklerini düşündürmektedir.

EMBU-C reddetme alt ölçeğinin iç tutarlılığı bu örneklemde sınırda gözlemlenmiş; psikometrik kısıtlama hesaba katılarak H1 bulgusu madde-yanıt teorisi latent θ skorlarıyla yeniden tahmin edilmiş ve β = 0,14 SD ile temel kovaryans analizi tahmininin yaklaşık %88'ini koruyarak ölçek-düzeyi bulgudan bağımsızlığını göstermiştir.

EMBU-C sıcaklık alt ölçeğinde grup farkı bulunmaması ("orta düzey H0" lehine kanıt), DM çocuklarının "anne sıcaklığını" Kontrol çocuklarıyla benzer düzeyde algıladığını fakat reddetme yorumlamada farklılaştığını göstermektedir; bu örüntü Cameron'un (2007) kronik hastalık aile sistemleri çerçevesinde anne aşırı denetim ve çocuk reddetme algısı bağlantısıyla uyumludur.

Pratik anlamda bulgu, klinik açıdan çift-perspektifli aile değerlendirmesinin (ISPAD 2024 ve ADA 2025/2026 önerisinin) ampirik temelini güçlendirmektedir.

## 15.3 H2 Tartışması: Kardeş İlişkisi Mimarisinin Sürekliliği

H2 SRQ alt ölçeklerinin dördünde de DM × Kontrol grup farkı bulgulanmamış olması, T1DM ailelerinde kardeş ilişkisinin temel boyutlarının (sıcaklık, statü, çatışma, rekabet) hastalık varlığından bağımsız olarak korunduğunu düşündürmektedir. Bu sonuç Stuart ve Hodges'ın (2003) kardeş kronik hastalık literatüründeki karma sonuçlarıyla tutarlıdır: bazı çalışmalar artmış çatışma raporlarken, bazıları artmış destek raporlamış; bazıları ise hiçbir fark bulamamıştır.

Mevcut bulgu klinik olarak "kardeş ilişkisi sağlam kalmış" yorumuna işaret etmektedir; ancak APIM tipi karma model Tip I hata kontrolü için yeterli güç sergilememiş olabilir. Bu nedenle "Indeterminate" konumlandırması raporlanmıştır. Daha güçlü bir negatif kanıt için TOST eşdeğerlik testi gelecek faz analiz hattına eklenmelidir; bu çalışmanın ön-kayıtlı planında H2 ailesi için TOST uygulaması bulunmamaktadır.

Önemli bir tamamlayıcı bulgu, indeks ↔ kardeş ayrımcı muamele oranının (Differential Parental Treatment) Kontrol grubunda %45, DM grubunda %48 düzeyinde olmasıdır. Buist, Deković ve Prinzie'nin (2013) meta-analizi, ayrımcı muamelenin kardeş ilişkisi kalitesi üzerinde küçük-orta düzeyde negatif etki gösterdiğini bildirmektedir. Mevcut çalışmada DM grubunda PDT oranının marjinal yüksek olması, kronik hastalık bağlamında bu mekanizmanın işlerliğini değerlendirmek için ek longitudinal veri ihtiyacını ortaya koymaktadır.

## 15.4 H3 Tartışması: Anne Öz-Bildirim Düzleminde Üç-Katmanlı Negatif Kanıt

H3 dört EMBU-P alt ölçeği için elde edilen üç-katmanlı negatif kanıt zinciri, anne ebeveynlik öz-bildiriminin T1DM bağlamında istatistiksel olarak homojen kaldığını göstermektedir. Bu sonuç birkaç farklı kuramsal çerçeveyle açıklanabilir:

**(a) Sosyal istenirlik temelli savunmacılık.** Kronik hastalık çocuklu anneler "iyi anne" temsiliyetine yüksek normatif baskı altındadır; sosyal istenirlik nedeniyle anne öz-bildirim ölçekleri grup farklarını sistematik olarak gizleyebilir. Streisand ve Monaghan'ın (2014) anne savunmacılığı hipotezi, mevcut çalışmadaki H3 ile H1/H5 asimetrisini açıklayan bir mekanizma sunmaktadır.
...
H3 negatif bulgusu, NICE NG18 ve ADA 2025/2026'nın T1DM aile takibinde *davranış sağlığı uzmanı* dahiliyetini öneren ifadelerinin yöneliminin **anne ebeveynlik tutumları değil, anne mental sağlık yükü ve aile psikososyal destek ihtiyacı** olması gerektiğini desteklemektedir. Bu, örneklemimizdeki yüksek antidepresan kullanım oranıyla (DM %29 vs Kontrol %9, SMD = 0,53) doğrudan örtüşmektedir.

## 15.5 H4 Tartışması: Goodman-Gotlib Modelinin Kısmi Doğrulanması

Goodman ve Gotlib'in (1999) entegratif modeli, anne depresyonunun çocuk gelişim çıktılarına dört aracı (genetik, prenatal, ebeveynlik davranışları, stres) üzerinden iletildiğini öne sürmektedir. Mevcut çalışmadaki H4 yapısal eşitlik modeli, bu zincirin **ebeveynlik-aracılı transmisyon yolu** parçasına karşılık gelmektedir.

Anne Beck depresyon latent faktörü, EMBU-P sıcaklık (β = −0,28), reddetme (β = 0,33) ve karşılaştırma (β = 0,28) alt ölçeklerinde FDR-düzeltilmiş anlamlı yapısal yollar üretmiştir. Aşırı koruma yolu yön olarak pozitif (β = 0,08) ancak FDR p = .22 ile anlamsızdır. Bu desen, anne depresif belirti yükünün ebeveynlik tutumları üzerindeki etkisinin **alt-boyut-spesifik** olduğunu — özellikle olumlu (sıcaklık) ve doğrudan olumsuz (reddetme, karşılaştırma) boyutlarda işlerken aşırı koruma kanalında bağımsız mekanizmalardan beslendiğini — düşündürmektedir.

Standardize yol katsayılarımız anlamlı üç yol için β = 0,28–0,33 aralığındadır; bu değerler Lovejoy ve diğerlerinin (2000) anne depresyonu ile olumsuz ebeveynlik için raporladığı meta-analitik d = 0,40 değerinin alt sınırı olan **orta-büyük etki sınıfında** kümelenmektedir. Bu desen, anne depresyonunun ebeveynlik tutumları üzerindeki yansımasının kültürel-örnek-bağlam gözetilmeksizin sıcaklık/reddetme/karşılaştırma kanallarında **tutarlı bir psikolojik mekanizma** olarak işlerliğini sürdürdüğünü; aşırı koruma kanalının ise bu transmisyonun dışında konumlandığını göstermektedir.

Multi-grup invaryans testlerinin sonucu (configural ve metric değişmezlik büyük ölçüde sağlanmış, scalar değişmezlik sınır düzeyde kabul edilmiş) anne depresyonunun ebeveynlik tutumları üzerindeki latent etkisinin grup üyeliğinden bağımsız, **evrensel bir mekanizma** olarak işlediğini işaret etmektedir. T1DM bağlamı bu mekanizmayı ek bir aracı veya moderator olarak değiştirmemektedir; aksine zincirin grup-invariant işlerliğini koruduğunu göstermektedir.
...
Yani: anne depresyonu → anne ebeveynlik tutumu zinciri (a yolu) güçlüdür; ancak anne ebeveynlik tutumu → çocuk ebeveynlik algısı zinciri (b yolu) zayıftır. Bu örüntü tam olarak De Los Reyes ve diğerlerinin (2015) Diverging Operations bulgusunun yapısal modelle doğrulanmış halidir: anne ile çocuk algısı farklı kanallarda işlenmektedir; anne depresyonu anne öz-bildirim ebeveynliği etkilemekte ancak bu etki çocuk algı düzeyine sistematik olarak iletilmemektedir.
...
## 16.1 Tasarım Kaynaklı Sınırlılıklar
...
## 16.2 Ölçüm Kaynaklı Sınırlılıklar
...
## 16.3 İstatistiksel Sınırlılıklar

- **Aktör-partner karşılıklı bağımlılık modeli ve düad doğrulayıcı faktör analizi için n = 241 düad sayısı:** Donner ve Eliasziw (1992) çerçevesinde ICC ≥ 0,20 için %85+ güç sağlanmış; ancak k-katsayısı ve RSA polinom regresyonu için DM (n = 120) ve Kontrol (n = 121) alt-örneklem güçleri sınır düzeydedir.
- **HbA1c örneklem büyüklüğü:** n = 39 düzeyindeki HbA1c örneklemi, DM klinik alt-analizler (KISIM X) için yetersiz güçtedir (Cohen, 1988 standardında power < 0,50). Bu nedenle HbA1c × ebeveynlik etkileşim sonuçları "keşifsel" etiketle raporlanmıştır.
...
## 16.4 Eksik Veri Kaynaklı Sınırlılıklar

- **HbA1c yapısal-olmayan eksiklik:** DM grubunda HbA1c eksikliği MAR varsayımı altında imputasyona açık olabilirdi; ancak biyobelirteç imputasyonu klinik araştırma standartlarında genellikle önerilmediği için bu yol tercih edilmemiştir.
...
## 16.5 Genelleştirilebilirlik Sınırlılıkları
...
## 17.1 Çalışmanın Bilimsel Konumu
...
**H1 — Çocuk-algısı reddetme (DM > Kontrol):** Sıklıkçı ve Bayesçi çerçeveler birlikte değerlendirildiğinde, β = 0,16 SD (BF₁₀ = 8,12) düzeyinde **küçük-orta büyüklükte yön kanıtı** elde edilmiştir. Etki anne öz-bildirim reddetmede gözlenmemiştir; bu **bilgi-veren bir tutarsızlıktır** ve literatürün anne savunmacılığı (defensive maternal reporting) hipoteziyle uyumlu yön sergilemektedir.
...
Çalışmanın ürettiği kanıt zincirinden Türkiye T1DM klinik pratiğine yönelik dört somut öneri çıkarılmaktadır.
...
**Öneri 4 — Davranış sağlığı uzmanı entegrasyonu:** ADA 2026 *Standards of Care* önerisi doğrultusunda, çocuk endokrinoloji multidisipliner ekibinde aile sistem perspektifli psikolog veya çocuk-ergen ruh sağlığı uzmanının yapısal entegrasyonu, bu çalışmanın diadik bulgularının pratiğe taşınması için yapısal önkoşuldur. Türkiye Sağlık Bakanlığı T1DM tanı-tedavi protokolünün psikososyal değerlendirme bileşeninin güçlendirilmesi önerilmektedir.
...
**Odak:** H3 (anne öz-bildirim ebeveynlik açısından grup eşdeğerliği) ve H4 (Beck → EMBU-P SEM aktarım modeli). Goodman ve Gotlib'in (1999) **dört-yol risk aktarım modelinin** kısmi doğrulanması: sıcaklık, reddetme ve karşılaştırma yolları için pozitif kanıt; aşırı koruma yolu için nötr sonuç.
...
- **Açık veri ve kod:** Anonimleştirilmiş düad düzeyi veri seti (L0-L1-L2 sınıflandırması) ve _targets.R orkestrasyonu OSF üzerinden açık erişime sunulacaktır (DOI rezervasyonu yapılacaktır). Ham bireysel veri, TÜBİTAK Açık Bilim Politikası ve KVKK uyumlu çerçevede yalnızca metaveri paylaşımıyla sınırlandırılacaktır.
...
Apalaçi, M. (1996). *Türkiye'de kardeş ilişkilerinin değerlendirilmesi: Sibling Relationship Questionnaire'in psikometrik özellikleri* [Yayımlanmamış yüksek lisans tezi]. Boğaziçi Üniversitesi.
...
International Society for Pediatric and Adolescent Diabetes (ISPAD). (2024). ISPAD Clinical Practice Consensus Guidelines 2024: Psychological care of children, adolescents and young adults with diabetes. *Pediatric Diabetes*, 25(Suppl. 5).
...
Stuart, J., & Hodges, J. K. (2003). Parenting style and adjustment in chronic illness: Toward a developmental perspective. *Children's Health Care*, 32(3), 165–179.
...
Tam paket seti ve hesaplama ortamı snapshot'ı `renv.lock` dosyası ile sabitlenmiş; paylaşım paketi doktora savunması sonrası açık bilim arşivine eklenecek biçimde hazırlanmıştır.

## Ek D — Analiz Pipeline (_targets.R Orkestrasyonu)

Çalışmanın tüm hesaplama akışı, `targets` paketinin orkestrasyon mantığıyla kurgulanmış olup aşağıdaki ana hat bağımlılıklarına göre çalıştırılmıştır:
