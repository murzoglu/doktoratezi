...
stopifnot(!any(path_findings$path == "docs/analiz_planlari/03-sap-ana-plan.md"))

safe_columns <- flag_sensitive_column_names(c("aile_no", "cocuk_no", "group", "role"))
safe_paths <- flag_sensitive_paths(c("R/08_data_governance.R", "docs/protokol/FINAL_REFERENCE_VERI_HARITASI.md"))
