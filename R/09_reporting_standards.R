...
reporting_standards_checklist <- function() {
  data.frame(
    ...
    artifact = c(
      ...
      "docs/analiz_planlari/STATISTICAL-ANALYSIS-PLAN.md",
      "docs/FINAL_REFERENCE_VERI_HARITASI.md",
      "docs/KANONIK_*.md",
      "docs/analiz_planlari/PRE-REGISTRATION-DEVIATION-TABLE.md",
      ...
      "docs/FINAL_REFERENCE_VERI_HARITASI.md",
      "docs/KANONIK_*.md",
      "docs/analiz_planlari/ETHICS-DATA-MANAGEMENT-PLAN.md",
      "outputs/tables/joint_display.*",
      "chapters/04_tartisma.qmd",
      "docs/analiz_planlari/ETHICS-DATA-MANAGEMENT-PLAN.md",
      "docs/analiz_planlari/REPRODUCIBILITY-RUNBOOK.md"
    ),
    status = c(
      "planned",
      "drafted",
