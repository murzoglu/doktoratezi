---
description: Bir tablo/şekil/diyagram/grafik/istatistik sonucu/metin bölümünü "basitçe ama detay atlamadan, ders anlatır gibi" izah et — kaynaktan doğrula, tipini tanı, sade dille anlat, değeri eşiğe oturt, gerçek sayıları koru
argument-hint: "[açıklanacak öğe — ör. Tablo 4.13 / Şekil 3.2 / H1 sonucu / CFI 0,887 / eğilim skoru]"
allowed-tools: Bash(grep *), Bash(sed *), Bash(ls *), Bash(nl *), Bash(awk *), Bash(head *), Read
---
...
1. **Kaynağı doğrula (ZORUNLU — atlanamaz).** Öğenin kanonik kimliğini bul (numara →
   ...
   üreten R modülünü/CSV'yi + çevre metnini `grep`/`sed`/gerekirse `researcher` ile oku.
   Aktaracağın her sayıyı kaynaktan **birebir** teyit et; metin↔CSV çelişkisi görürsen
   açıklama yazma, çelişkiyi bildir. Öğe belirsizse tahmin etme; netleştir.
